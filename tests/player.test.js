...
test('UUID to NAME', done => {
    mc.uuidToName(new mc.player('Sigma76')).then(data => {
...
test('NAME to UUID', done => {
    mc.nameToUuid(new mc.player('Sigma76')).then(data => {
...
test('Get Skin', done => {
    mc.getSkin(new mc.player('Sigma76')).then(data => {
...
test('Get Name History', done => {
    mc.getNameHistory(new mc.player('Sigma76')).then(data => {
...
test('Get Name History at Time', done => {
    mc.getNameAtDate(new mc.player('NoWeDont'), new Date(2015, 5, 1)).then(data => {
